...
X_train = [X(pos(1:41,:),:) ; X(neg(1:41,:),:)];
X_test = [X(pos(42:58,:),:) ; X(neg(42:60,:),:)];
y_train = [y(pos(1:41,:)) ; y(neg(1:41,:))];
y_test = [y(pos(42:58,:)) ; y(neg(42:60,:))];
...
[cost, grad] = costFunctionReg(test_theta, X_train, y_train, 10);
